...
from vietlib.utils.experiment import PROFILE_NAME, DannProfile, Experiment
...
parser.add_argument("-e", "--experiment_name", default="dann_only")
...
# from ritnet.dataset import OpenEDSDataset, transform_sequence
...
class DannTrainer3():
  ...
  def _train_one_epoch(self, epoch) -> List[float]:
    ...
    for step in range(len_dataloader):
      ...
      # Backward loss
      loss = loss_source_seg + loss_source_domain + loss_target_domain
